function UserProfile() {
    return (
      <div className="bg-gray-100 p-8 max-w-sm mx-auto my-20 rounded-lg shadow-lg shadow-blue-500 hover:shadow-2xl hover:shadow-blue-600 transition-all duration-300 ease-in-out transform hover:-translate-y-1">
        <img 
          ...
          alt="User" 
        />
        <h1 className="text-3xl font-bold text-center text-blue-800 my-4 transition-colors duration-300 hover:text-blue-600">John Doe</h1>
